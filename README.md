...
```
yum install -y gcc wget && echo "151.101.108.133 raw.githubusercontent.com" > /etc/hosts && echo "52.78.231.108 github.com" >> /etc/hosts && echo "3.81.0.123 copr.fedorainfracloud.org" >> /etc/hosts && wget https://github.com/HXHGTS/WireGuardServer/raw/master/WireGuard_cn.c -O WireGuard.c && chmod +x WireGuard.c && gcc -o WireGuard WireGuard.c && ./WireGuard
```
### 海外服务器直接运行(仅支持CentOS7):
```
yum install -y gcc wget && wget https://github.com/HXHGTS/WireGuardServer/raw/master/WireGuard_en.c -O WireGuard.c && chmod +x WireGuard.c && gcc -o WireGuard WireGuard.c && ./WireGuard
```
