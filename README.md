...
`yum install -y gcc wget && echo '3.81.0.123 copr.fedorainfracloud.org' > /etc/hosts && echo '151.101.112.133 raw.githubusercontent.com' >> /etc/hosts && wget https://raw.githubusercontent.com/HXHGTS/WireGuardServer/master/WireGuard.c -O WireGuard.c && chmod +x WireGuard.c && gcc -o WireGuard WireGuard.c && ./WireGuard`
